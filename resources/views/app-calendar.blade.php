...
<html
  ...
  dir="ltr"
  data-skin="default"
  data-assets-path="{{ asset('calendar-assets/') }}/"
...
<head>
  ...
  <title>Calendar | Laravel</title>

  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="{{ asset('calendar-assets/img/favicon/favicon.ico') }}" />
  ...
  <!-- Icons -->
  <link rel="stylesheet" href="{{ asset('calendar-assets/vendor/fonts/iconify-icons.css') }}" />

  <!-- Core CSS -->
  <link rel="stylesheet" href="{{ asset('calendar-assets/vendor/libs/node-waves/node-waves.css') }}" />
  <link rel="stylesheet" href="{{ asset('calendar-assets/vendor/libs/pickr/pickr-themes.css') }}" />
  <link rel="stylesheet" href="{{ asset('calendar-assets/vendor/css/core.css') }}" />
  <link rel="stylesheet" href="{{ asset('calendar-assets/css/demo.css') }}" />

  <!-- Vendors CSS -->
  <link rel="stylesheet" href="{{ asset('calendar-assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />
  <link rel="stylesheet" href="{{ asset('calendar-assets/vendor/libs/fullcalendar/fullcalendar.css') }}" />
  <link rel="stylesheet" href="{{ asset('calendar-assets/vendor/libs/flatpickr/flatpickr.css') }}" />
  <link rel="stylesheet" href="{{ asset('calendar-assets/vendor/libs/select2/select2.css') }}" />
  <link rel="stylesheet" href="{{ asset('calendar-assets/vendor/libs/quill/editor.css') }}" />
  <link rel="stylesheet" href="{{ asset('calendar-assets/vendor/libs/@form-validation/form-validation.css') }}" />

  <!-- Page CSS -->
  <link rel="stylesheet" href="{{ asset('calendar-assets/vendor/css/pages/app-calendar.css') }}" />

  <!-- Helpers -->
  <script src="{{ asset('calendar-assets/vendor/js/helpers.js') }}"></script>
  <script src="{{ asset('calendar-assets/vendor/js/template-customizer.js') }}"></script>
  <script src="{{ asset('calendar-assets/js/config.js') }}"></script>
</head>
...
<script src="{{ asset('calendar-assets/vendor/libs/jquery/jquery.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/libs/popper/popper.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/js/bootstrap.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/libs/node-waves/node-waves.js') }}"></script>

<script src="{{ asset('calendar-assets/vendor/libs/@algolia/autocomplete-js.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/libs/pickr/pickr.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/libs/hammer/hammer.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/libs/i18n/i18n.js') }}"></script>

<script src="{{ asset('calendar-assets/vendor/js/menu.js') }}"></script>

<!-- endbuild -->

<!-- Vendors JS -->
<script src="{{ asset('calendar-assets/vendor/libs/fullcalendar/fullcalendar.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/libs/@form-validation/popular.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/libs/@form-validation/bootstrap5.js') }}"></cript>
<script src="{{ asset('calendar-assets/vendor/libs/@form-validation/auto-focus.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/libs/select2/select2.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/libs/moment/moment.js') }}"></script>
<script src="{{ asset('calendar-assets/vendor/libs/flatpickr/flatpickr.js') }}"></script>

<!-- Main JS -->
<script src="{{ asset('calendar-assets/js/main.js') }}"></script>

<!-- Page JS -->
<script src="{{ asset('calendar-assets/js/app-calendar-events.js') }}"></script>
<script src="{{ asset('calendar-assets/js/app-calendar.js') }}"></script>
